...
<body class="antialiased min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-red-500/20 rounded-full blur-[100px] -z-10"></div>
    ...
    <div class="text-center max-w-lg z-10 p-10 bg-white/5 border border-white/10 rounded-3xl backdrop-blur-xl shadow-2xl">
        ...
        <h1 class="text-6xl font-bold tracking-tight text-white mb-2">403</h1>
        <h2 class="text-2xl font-semibold text-gray-200 mb-4">Access Denied</h2>
        <p class="text-gray-400 font-light mb-8">{{ $exception->getMessage() ?: 'You do not have permission to view this page or your role is still pending.' }}</p>
